...
export const messages: Record<Lang, Record<string, string>> = {
    uk: {
        ...
        MAIN_MENU_CHOOSE_ACTION: '📋 Оберіть дію з меню:',
        MENU_BTN_ADD_ADDRESS: '➕ Додати адресу',
        MENU_BTN_ADD_PARKING: '🚗 Додати місце',
        MENU_BTN_JOIN_ADDRESS: '🏘 Приєднатись',
        MENU_BTN_SET_GUARD: '🛡 Охоронець',
        MENU_BTN_MY_SPOTS: '📦 Мої місця',
        MENU_BTN_WITHDRAW: '💰 Вивід коштів',
        MENU_BTN_MY_RENTALS: '📑 Мої оренди',
        MENU_BTN_SEARCH: '🔍 Пошук місць',
    ...
    en: {
        ...
        MAIN_MENU_CHOOSE_ACTION: '📋 Choose an action:',
        MENU_BTN_ADD_ADDRESS: '➕ Add address',
        MENU_BTN_ADD_PARKING: '🚗 Add spot',
        MENU_BTN_JOIN_ADDRESS: '🏘 Join address',
        MENU_BTN_SET_GUARD: '🛡 Guard',
        MENU_BTN_MY_SPOTS: '📦 My spots',
        MENU_BTN_WITHDRAW: '💰 Withdraw',
        MENU_BTN_MY_RENTALS: '📑 My rentals',
        MENU_BTN_SEARCH: '🔍 Search spots',
